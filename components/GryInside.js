...
import { Image, Flex, useColorModeValue, Heading, Text, chakra, Wrap, WrapItem } from '@chakra-ui/react';
                            ...
                            <motion.div initial="hidden"
                                ...
                                <Flex
                                    ...
                                    <Flex flexDir={'column'} lineHeight={'150%'}>
                                        ...
                                        <Wrap my={'10px'} flexDir={'row'} w={'100%'} justify='center' spacing={'20px'}>
                                            <WrapItem maxW={'180px'} h={'50px'} justifyContent={'space-between'} alignItems={'center'} px={'2px'} mr={'10px'}>
                                            ...
                                            {Games.dependencies.map((dependent) => {
                                                return (
                                                    <WrapItem key={dependent.id} maxW={'180px'} h={'50px'} justifyContent={'space-between'} alignItems={'center'} px={'2px'} mr={'10px'}>
